...
def test_write_transcriptome_zarr_transposes_gene_by_sample_table(tmp_path):
    ...
    summary = write_transcriptome_zarr(zip_path, output_dir, row_chunk_size=2, column_chunk_size=2)
...
def test_write_transcriptome_zarr_maps_zero_variance_genes_to_zero(tmp_path):
    ...
    write_transcriptome_zarr(zip_path, output_dir, row_chunk_size=2, column_chunk_size=2)
...
def test_write_transcriptome_zarr_preserves_missing_expression_values(tmp_path):
    ...
    write_transcriptome_zarr(zip_path, output_dir, row_chunk_size=3, column_chunk_size=1)
